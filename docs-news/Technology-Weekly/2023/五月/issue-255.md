...
sidebar_label: 第 255 期：对待 AI 的正确态度
title: 第 255 期：对待 AI 的正确态度
...
我正好看到一篇<!-- [印度程序员的文章](https://github.com/ixaxaar/VardaGPT/blob/master/STORY.md) 链接已失效 -->印度程序员的文章，他也在思考这个问题，就决定亲自测试一下，AI 发展到了什么程度。
